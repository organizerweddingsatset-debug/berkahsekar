...
object PrinterHelper {
    ...
    // Fungsi baru: print dengan logo (untuk printer yang support raster image)
    // Untuk sekarang logo di struk preview akan pakai text-based, versi bitmap menyusul
    fun buildReceiptWithLogoFlag(hasLogo: Boolean = true): Boolean = hasLogo
