...
object PrinterHelper {
        const val DEFAULT_TOKO = "TOKO BERKAH SEKAR"
        const val DEFAULT_MODAL = 15000000.0

        fun buildReceiptPreviewText(
            tokoName: String = DEFAULT_TOKO,
            ...
            lines.add("      ${tokoName.uppercase()}")
            lines.add("  Surabaya - Toko Berkah Sekar")
            lines.add("--------------------------------")
            ...
            lines.add("--------------------------------")
            lines.add(" Terima kasih belanja di Berkah Sekar!")
