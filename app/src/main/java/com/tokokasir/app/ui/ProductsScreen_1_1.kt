...
@Composable fun SettingsScreen(nav: NavController) { Column(Modifier.padding(16.dp)) { Text("Pengaturan: Nama Toko, Modal Awal, Printer Bluetooth Address, Notifikasi, PIN Kasir"); OutlinedTextField(value="TOKO BAROKAH", onValueChange={}, label={Text("Nama Toko")}); Spacer(Modifier.height(8.dp)); OutlinedTextField(value="10000000", onValueChange={}, label={Text("Modal Awal")}) } }
